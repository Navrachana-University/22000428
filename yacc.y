...
%token JEDI SITH LIGHTSABER FORCE HYPERDRIVE BLASTER STARSHIP TRANSMISSION SECTOR THEN ELSE ENDSECTOR
...
%left FORCE HYPERDRIVE
%left BLASTER STARSHIP

%%
program:
    JEDI statements SITH { /* Program complete */ }
    ;
...
statement:
    LIGHTSABER ID { /* Declare variable, no TAC needed */ }
    | ID '=' expression {
        fprintf(yyout, "%s = %s\n", $1, $3);
        free($3);
    }
